...
.citem.bad    { background: rgba(100, 116, 139, 0.12); border-color: rgba(100, 116, 139, 0.30); }

/* 篩選工具列 */
.view-title { position: sticky; top: 0; z-index: 10; background: var(--bg); padding: 12px 0 10px; border-bottom: 1px solid var(--line); margin-bottom: 16px; }
...
const ZERO_LABELS = { all: '全部留言', hide: '隱藏 👎', solo: 'solo 👎' };
